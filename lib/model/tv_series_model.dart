...
List<TvSeries> tvSeriesFromJson(String str) => List<TvSeries>.from(json.decode(str).map((x) => TvSeries.fromJson(x)));

String tvSeriesToJson(List<TvSeries> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
